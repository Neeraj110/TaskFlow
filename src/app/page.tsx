export default function Home() {
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden bg-[radial-gradient(circle_at_top,#fff,#f3ede4,#f7f4ef)]">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col gap-16 px-6 py-16">
        <header className="flex flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <a className="text-sm font-medium text-zinc-600 hover:text-zinc-900" href="/login">Login</a>
              <a className="rounded-full bg-zinc-900 px-4 py-2 text-sm font-medium text-white" href="/signup">Get started</a>
            </div>
          </div>
